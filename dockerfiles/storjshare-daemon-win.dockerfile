...
ADD https://raw.githubusercontent.com/StorXNetwork/xcore-daemon/master/dockerfiles/get_dep_ver.ps1 get_dep_ver.ps1
...
RUN .\get_dep_ver.ps1; \
    ...
    Write-Host npm install --global StorXNetwork/xcore-daemon --unsafe-perm; npm install --global StorXNetwork/xcore-daemon --unsafe-perm; \
